...
<div class="container-fluid">
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.landing.schedules.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="team_home" class="form-control @error('team_home') is-invalid @enderror" value="{{ old('team_home') }}">
                        @error('team_home')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="team_away" class="form-control @error('team_away') is-invalid @enderror" value="{{ old('team_away') }}">
                        @error('team_away')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" name="match_date" class="form-control @error('match_date') is-invalid @enderror" value="{{ old('match_date') }}" required>
                        @error('match_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="score_home" class="form-control @error('score_home') is-invalid @enderror" value="{{ old('score_home') }}" min="0">
                        @error('score_home')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="score_away" class="form-control @error('score_away') is-invalid @enderror" value="{{ old('score_away') }}" min="0">
                        @error('score_away')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
